...
export function ProblemForm() {
  ...
  return (
    <div className="text-white">
      <h2 className="text-xl font-bold mb-6">新增题目</h2>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <button type="submit" disabled={isPending} className="px-4 py-2 bg-indigo-600 text-white font-semibold rounded-md shadow-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:bg-gray-500">
          {isPending ? '提交中...' : '提交'}
        </button>
      </form>
    </div>
